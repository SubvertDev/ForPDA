...
let package = Package(
    ...
    dependencies: [
        // TCA
        .package(url: "https://github.com/pointfreeco/swift-composable-architecture.git", from: "1.23.2"),
        ...
        .package(url: "https://github.com/SubvertDev/PDAPI_SPM.git", exact: "0.7.1"),
