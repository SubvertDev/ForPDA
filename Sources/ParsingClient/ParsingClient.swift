...
extension ParsingClient: DependencyKey {
    public static let liveValue = Self(
        parseArticlesList: { rawString in
            return try ArticlesParser.parse(from: rawString)
        }
    )
}
...
//    // MARK: - Comments
//    
//    func parseComments(from document: String) -> [Models.CommentOld] {
//        let document = try! SwiftSoup.parse(document)
...
//    }
//    
//    private func recurseComments(commentList: Elements, level: Int) -> [Models.CommentOld] {
//        var allComments = [Models.CommentOld]()
...
//    }
//    
//    private func getCommentFromElement(_ element: Element, replies: [AbstractComment] = [], level: Int) -> Models.CommentOld {
