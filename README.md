...
- Профили, краткая информация, статистика и достижения, редактирование
...
### В планах
- Закладки
- Поддержка файлов/бб-кодов в QMS
...
Q: Планируется ли версия под iPadOS?
A: Да, когда-нибудь сделаем
...
## Лицензия
GPL v3 (C) 2022-2026 [Ilia Lubianoi](https://github.com/SubvertDev)
